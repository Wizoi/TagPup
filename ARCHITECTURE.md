...
- [ ] Face roots from the tree only (#66). A root holds faces when its node says so; the lists of root names in the code go, and a new library is seeded with one face root, People.
