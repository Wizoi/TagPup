...
logger = logging.getLogger("photo_tagger.taxonomy")

class TagTaxonomy:
    def __init__(self, file_path: str = "data/photo_taxonomy.json"):
        self.file_path = file_path
        # Store full paths of known hierarchical tags, e.g., {"Family/Immediate/Linnea Ingersoll", "Activity/Botanical Garden"}
