...
| 7 | 2026-09-23 | `backups/` holds 28 GB in 41 copies. Scripts also wrote copies next to the code they ran from. | open: the owner decides which copies to keep. New backups go beside the library, in `data/backups/`, since *refactor: Library names a library and what belongs to it*. |
