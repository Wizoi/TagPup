...
| 2026-09-25 | Each library keeps three daily, one weekly and one monthly snapshot, taken by sync (phase 8) under the write lock, checked before an old one is removed, and restorable with the journal's changes since counted *(owner)*. |
